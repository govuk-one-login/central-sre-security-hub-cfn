...
def create_secret(service_client, arn, token):
    ...
    new secret and put it with the passed-in token as the version Id.
    ...
    """
    try:
    # Check if the current secret exists
        ...
        # Replace this call with a different function if you require a service-specific secret format
...
def set_secret(service_client, arn, token):
    ...
    logger.info("Sending secret to fake service")
...
def test_secret(service_client, arn, token):
    ...
    logger.info("Testing secret against fake service")
